...
var AccountFetch = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetch("".concat(API_URL).concat(API_PORT).concat(ENDPOINT), {
                                method: 'GET',
                                headers: {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("h1", null, "This is called by fetch"),
        react_1.default.createElement(reactstrap_1.Table, null,
            ...
            react_1.default.createElement("tbody", null, account && account.map(function (item, index) { return (react_1.default.createElement("tr", { key: item.userid },
